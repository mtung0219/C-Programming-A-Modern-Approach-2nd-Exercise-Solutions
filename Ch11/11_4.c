...
void analyze_hand(bool* straight, bool* flush, bool* four, bool* three, int* pairs, int[], int[]);
...
void analyze_hand(bool *straight, bool *flush, bool *four, bool *three, int *pairs, int num_in_rank[NUM_RANKS], int num_in_suit[NUM_SUITS])
{
	int num_consec = 0;
	int rank, suit;
	*straight = false;
